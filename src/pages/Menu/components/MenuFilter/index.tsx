...
const chipActive = "bg-primary text-white shadow-sm shadow-primary/30";
const chipInactive =
  "bg-[#f4f1f0] dark:bg-white/5 text-blackCustom dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/10";
